...
{
    public class SaveKh3PC : ISaveKh3
    {
        [Data(0, 0x94F4F0)] public byte[] Data { get; set; }
        ...
        [Data(0x83CD8)] public Records Records { get; set; }

        [Data(0x85028)] public int PhotoMaxCount { get; set; }
        [Data(0x8503C, 90, 0x19004)] public List<PhotoEntry> Photos { get; set; }
        [Data(0x94F1A4, Count = 0x100)] public string DlcMapPath { get; set; }
        [Data(0x94F2A4, Count = 0x40)] public string DlcSpawnPoint { get; set; }
        ...
        internal static bool IsValidInternal(Stream stream)
        {
            ...
            return magicCode == 0x45764053 && length == 0x94F4D8;
        }
